...
#
# Output Format: list of senses and movements:
...
def slam(data, N, num_landmarks, motion_noise, measurement_noise):
    ...
    omega = matrix()
    matrix_dimension = 2 * (N + num_landmarks)
    ...
    for index in range(len(data)):
        ...
        for landmark in landmarks:
            ...
            landmark_index_x = landmark_base_index + 2 * landmark_number
            landmark_index_y = landmark_index_x + 1
            position_index_x = 2 * index
            position_index_y = position_index_x + 1
        ...
        init_position_index_x = 2 * index
        init_position_index_y = init_position_index_x + 1
        final_position_index_x = 2 * (index + 1)
        final_position_index_y = final_position_index_x + 1

        omega.value[final_position_index_x][final_position_index_x] += 1 / motion_noise
        omega.value[final_position_index_x][init_position_index_x] -= 1 / motion_noise
        xi.value[final_position_index_x][0] += x_movement / motion_noise
        omega.value[init_position_index_x][init_position_index_x] += 1 / motion_noise
        omega.value[init_position_index_x][final_position_index_x] -= 1 / motion_noise
        xi.value[init_position_index_x][0] -= x_movement / motion_noise

        omega.value[final_position_index_y][final_position_index_y] += 1 / motion_noise
        omega.value[final_position_index_y][init_position_index_y] -= 1 / motion_noise
        xi.value[final_position_index_y][0] += y_movement / motion_noise
        omega.value[init_position_index_y][init_position_index_y] += 1 / motion_noise
        omega.value[init_position_index_y][final_position_index_y] -= 1 / motion_noise
        xi.value[init_position_index_y][0] -= y_movement / motion_noise
